"""
Pasted from: https://github.com/pytorch/vision/blob/master/torchvision/datasets/utils.py
"""
...
# on 10/11/2019 these urls don't seem to work
ARCHIVE_DICT = {
    'train': {
    ...
    'meta.bin':{
        'dir': '/fs/vulcan-scratch/ilyak/locDoc/data/imagenet/meta.bin',
        'md5': 'ca981e8aac175178e80e7949d90ee85c',
    },
}
...
class ImageNet(ImageFolder):
    ...
    def download(self):
        if not check_integrity(self.meta_file, ARCHIVE_DICT['meta.bin']['md5']):
        ...
        if not os.path.isdir(self.split_folder):
            raise ValueError("Dataset folder '%s' does not exist" % self.split_folder)
    ...
    @property
    def meta_file(self):
        return ARCHIVE_DICT['meta.bin']['dir']

    def _load_meta_file(self):
        if check_integrity(self.meta_file, ARCHIVE_DICT['meta.bin']['md5']):
